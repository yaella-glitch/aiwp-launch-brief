...
export function Hero({ presentMode }: { presentMode: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'relative z-10 mx-auto w-full max-w-[1400px] px-6 md:px-10 lg:px-16',
          presentMode ? 'py-24' : 'py-28 md:py-32',
        )}
      >
        <div className="max-w-5xl">
          ...
          <motion.p
            ...
            className="mt-10 text-eyebrow uppercase text-accent"
          >
            {hero.eyebrow}
          </motion.p>
          ...
          <motion.p
            ...
            className="mt-12 max-w-3xl text-lead font-medium text-white/90"
          >
            {hero.subhead}
          </motion.p>
          ...
          <motion.div
            initial={reduce ? undefined : { opacity: 0, y: 12 }}
            animate={reduce ? undefined : { opacity: 1, y: 0 }}
            transition={{ duration: 0.85, delay: 1.75 }}
